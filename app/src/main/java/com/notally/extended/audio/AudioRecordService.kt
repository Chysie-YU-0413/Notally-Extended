package com.notally.extended.audio
...
import com.notally.extended.activities.RecordAudio
import com.notally.extended.audio.Status.PAUSED
import com.notally.extended.audio.Status.READY
import com.notally.extended.audio.Status.RECORDING
...
class AudioRecordService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "com.notally.extended.audio"
