...
import com.notally.extended.room.dao.BaseNoteDao
import com.notally.extended.room.dao.CommonDao
import com.notally.extended.room.dao.LabelDao
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * allowMainThreadQueries() is only used in [com.notally.extended.ReminderReceiver.onReceive]
